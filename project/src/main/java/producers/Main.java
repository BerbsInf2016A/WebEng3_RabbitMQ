...
import producers.weatherProducer.WeatherDataDto;
import producers.weatherProducer.WeatherProducer;
import producers.youtubeProducer.YoutubeDataDto;
...
public class Main {
    ...
    // TODO Every producer should have it's own main class. This is only for development and debugging.
        ...
        try {
            ...
            while (true) {
                ...
                for (int plz : weatherProducer.getPlzSet()) {
                    weatherProducer.sendMessage(new WeatherDataDto(plz, 10, "Testname_" + plz));
                }
                for (int plz : youtubeProducer.getPlzSet()) {
                    youtubeProducer.sendMessage(new YoutubeDataDto(plz, "Testname_" + plz, "Mosbach , Fahr mal hin (SWR 2002)",
                    ...
                    youtubeProducer.sendMessage(new YoutubeDataDto(plz, "Testname_" + plz, "Vlog #1 in Mosbach Teil 1",
